	...
	public class Kernel : Sys.Kernel
	{
		...
		protected override void Run()
		{
			...
			switch (input.ToLower())
			{
				...
				default:
					Console.WriteLine("\"" + input + "\" is not a recognized command. Enter \"help\" for a list of commands.");
					break;
			}
		}
		...
		private static void PrintTime()
		{
			...
			Console.WriteLine(StringExtensions.FormatString("Current time is {0}:{1}:{2}{3} on {4}, {5} {6}.", hour, minute, second, amPm, weekday, Months[month - 1], day.AddOrdinal()));
		}
